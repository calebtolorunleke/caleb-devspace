  ...
  return (
    <div className="pb-18">
      ...
      >
        ...
        >
          <RiReactjsLine
            className={`text-7xl ${isDark ? "text-cyan-300" : "text-cyan-600"}`}
          />
        </motion.div>
        ...
        >
          <SiTypescript
            className={`text-7xl ${isDark ? "text-blue-400" : "text-blue-600"}`}
          />
        </motion.div>
        ...
        >
          <SiTailwindcss
            className={`text-7xl ${isDark ? "text-cyan-400" : "text-sky-500"}`}
          />
        </motion.div>
        ...
        >
          <SiMongodb
            className={`text-7xl ${isDark ? "text-green-500" : "text-emerald-600"}`}
          />
        </motion.div>
        ...
        >
          <FaNodeJs
            className={`text-7xl ${isDark ? "text-green-500" : "text-green-600"}`}
          />
        </motion.div>
        ...
        >
          <BiLogoPostgresql
            className={`text-7xl ${isDark ? "text-blue-400" : "text-sky-700"}`}
          />
        </motion.div>
      </motion.div>
    </div>
